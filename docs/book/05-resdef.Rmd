...
There is a special kind of residue definition called an "anonymous definition". These definitions are not specific to any residue name and so their [`residue_name`] attribute is `None`. The canonical names of their atoms act only as identifiers and are not expected to be found in the PDB file. As they have no residue name, they cannot be matched during residue-by-residue matching, and can only be provided to the [`additional_definitions`] argument.
...
[`ResidueDefinition.react`]: openff.pablo.ResidueDefinition.react
[`react`]: openff.pablo.ResidueDefinition.react
